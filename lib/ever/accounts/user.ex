defmodule Ever.Accounts.User do
  use Ever.Schema
  ...
  schema "users" do
    ...
    has_many(:workspace, Ever.Workspaces.Workspace)
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Ever.Repo)
  ...
  """
  def valid_password?(%Ever.Accounts.User{hashed_password: hashed_password}, password)
